		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Employee List",
									"targetURL": "#comsmodemployeelistapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsmodemployeelistapp-display": {
								"semanticObject": "comsmodemployeelistapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.smod.employeelistapp",
									"url": sap.ui.require.toUrl("com/smod/employeelistapp")
								}
							}
						}
					}
